...
def parse_svamp_answers_from_jsonl(json_path, tokenizer):
    data = []
...
def evaluate_svamp_results(directory, tokenizer_path):
    ...
    for file_path in jsonl_files:
        ...
        try:
            (
                ...
                raw_tokens,
                eot_count,
            ) = parse_svamp_answers_from_jsonl(json_path=file_path, tokenizer=tokenizer)
    ...
    if total_processed > 0:
        ...
        eot_prop = (
            agg_results["total_eot"] / agg_results["total_raw_tokens"] * 100
            if agg_results["total_raw_tokens"] > 0
            else 0
        )
    else:
...
if __name__ == "__main__":
    ...
    evaluate_svamp_results(directory=args.res_path, tokenizer_path=args.model_path)
